 ...
 */
public class TonightChangeDescriptionEventDialog extends DialogFragment{
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setView(view)
                ...
                .setPositiveButton(R.string.dialog_change_event_button_confirm,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                /* Setting new status */
                                mEvent.setDescription(change.getText().toString());
                                /* Uploading event */
                ...
                .setNegativeButton(R.string.dialog_change_event_button_cancel,
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                TonightChangeDescriptionEventDialog.this.getDialog().cancel();
                            }
                        });
