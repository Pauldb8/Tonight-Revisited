...
public class UserAvatar extends NetworkImageView {
    ...
    public UserAvatar(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.UserAvatar_ua_border_width, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.UserAvatar_ua_border_color, DEFAULT_BORDER_COLOR);
